...
const DrawerApp = ({ paramsData, categorytreeData }) => {
    ...
    const list = () => (
        <>
            ...
            >
                <List>
                    <ListItem button component={Link} to="/">
                        ...
                        <ListItemText primary={paramsData.shop_name_rus} />
                    </ListItem>
                ...
                <List>
                    {paramsData.topLinks.map((item, index) => (
                        <ListItem button key={index + 'topl'} component={Link} to={item.url}>
                            <ListItemIcon><Icon fontSize="small">{item.icons}</Icon></ListItemIcon>
            ...
            <div className={classes.search}><Search fclose={setOpenCallback} /></div>
        </>
    );
