...
import { RETURN_CALL_QUERY } from "../../../graphql/gqlQuery";
import { useQueryApp } from "../../../hooks/appolloQueryApp.hook";
import { RETURN_CALL_MUTATION } from "../../../graphql/gqlMutation";
import {
  FormDataClass,
  useMutationApp,
...
const ReturnCall = ({ handleClose }) => {
  const { data } = useQueryApp(RETURN_CALL_QUERY);
  ...
  const { mutate } = useMutationApp(RETURN_CALL_MUTATION, onCompleted);
