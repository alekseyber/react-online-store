...
const DeliveryCityInput = ({ variant }) => {
    ...
    return (
        ...
        <CssAutocomplete
            ...
            renderOption={(option) => (
                <div>
                    <Typography variant="body1" component="div">{option.cityName}</Typography>
                    <Typography variant="body2" component="div" gutterBottom>{option.oblName}</Typography>
                </div>
            )}
                        ...
                        endAdornment: (
                            <>
                                ...
                                <InputAdornment position="end">
                                    <IconButton size="small" onClick={handleClearInput} disabled={(searchTerm.length === 0)}>
