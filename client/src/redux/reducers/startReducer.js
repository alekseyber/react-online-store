...
const initialState = {
    ...
    yaMapKey: process.env.REACT_APP_YMAP_KEY || 'b43c189e-389a-4ccc-b79e-436d89a914ee',
    googleReKey: process.env.REACT_APP_RE_KEY || '6LdMXcQUAAAAAMDZv8aiNoBc1poD0Yd6fZjeivKN',
}
...
const handlers = {
    ...
    [SET_APP_SORT]: (state, { payload }) => ({ ...state, sortData: { ...state.sortData, sortValue: payload } }),
    DEFAULT: state => state
}
