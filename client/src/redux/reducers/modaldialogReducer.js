...
const handlers = {
  [SET_DIALOG]: (state, { payload }) => ({
    ...state,
    modalRootData: { ...state.modalRootData, ...payload },
  }),
  [OPEN_DIALOG]: (state, { payload }) => ({
    ...state,
    modalPrevData: state.modalRootData.open ? state.modalRootData : null,
    modalRootData: { ...state.modalRootData, ...payload },
  }),
  ...
  [HIDE_DIALOG]: (state) => ({
    ...state,
    modalRootData: state.modalPrevData
      ? state.modalPrevData
      : { ...state.modalRootData, open: false },
    modalPrevData: null,
  }),  
  [SET_SIZECHART_SELECT]: (state, { payload }) => ({
    ...state,
    sizechartSelect: payload.sizechart,
    modalRootData: { ...state.modalRootData, ...payload.modalDialogData },
  }),
